...
# %% auto 0
__all__ = ['sp', 'in_the_loop', 'chat', 'cbs', 'ip', 'parse_cell', 'fr_line', 'load_ipython_extension',
           'unload_ipython_extension', 'inject_js', 'patch_kernel', 'add_cell', 'update_cell', 'execute_cell',
           'render_cell', 'TeeIO', 'ExecCBs', 'get_index', 'CellChat', 'fr_cell']
